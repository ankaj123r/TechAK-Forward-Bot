...
main_buttons = [[
    InlineKeyboardButton('🤖 ᴅᴇᴠᴇʟᴏᴘᴇʀ 🤖', url='https://t.me/techak_01')
],[
    InlineKeyboardButton('🔍 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/techak_support'),
    InlineKeyboardButton('📢 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/techak_bott')
],[
